...
#define WHITE_BISHOP    (2*BISHOP + WHITE) // 4
#define BLACK_BISHOP    (2*BISHOP + BLACK) // 5
#define WHITE_ROOK      (2*ROOK   + WHITE) // 6
#define BLACK_ROOK      (2*ROOK   + BLACK) // 7
#define WHITE_QUEEN     (2*QUEEN  + WHITE) // 8
#define BLACK_QUEEN     (2*QUEEN  + BLACK) // 9
#define WHITE_KING      (2*KING   + WHITE) // 10
#define BLACK_KING      (2*KING   + BLACK) // 11
#define EMPTY           (BLACK_KING  +  1) // 12
